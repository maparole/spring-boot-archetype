...
/**
 * 
 * This test class and the CustomerBisIT class will be executed in the same cached ApplicationContext without reload since they both define equal contexts via
 * their annotations
 * 
 */
@IntegrationTest
public class CustomerContextOneIT {
